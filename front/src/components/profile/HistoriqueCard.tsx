...
const HistoriqueCard = () => {
  return (
    <div className='bg-[#3E504D]  w-full h-[47px] lg:h-[85px] flex justify-between mx-2 my-2 rounded-md' >
        <div className='flex flex-col overflow-hidden items-center justify-center lg:mx-8'>
            <div className='w-[28px] h-[28px] lg:h-[3.39vh] lg:w-[3.39vw] mx-2'>
                <MyAvatar/>
            </div>
            <span className='text-[0.625em] lg:text-[1em] font-semibold text-white mx-2 lg:mx-4' >azouhadou</span>
        </div>

        <div className='flex items-center cursor-default'>
          <div className={`bg-transparent text-secondary flex justify-center items-center gap-2 border rounded-full border-secondary 
