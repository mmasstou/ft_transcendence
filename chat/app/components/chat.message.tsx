...
const Message = (props: messagesType) => {
    ...
    return <div className="flex flex-col gap-1 bg-[#243230] p-3 rounded">
        <div className="message-body flex flex-row gap-2 items-center">
            <div className="image w-[2rem] rounded-full overflow-hidden"> <Image src={"/avatar.jpg"} alt={"avatar"} width={32} height={32} /></div>
